...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                msgBox = $('.msgBox',obj);
                if(msgBox.length == 0){
                  msgBox = $('<div class="msgBox"><div class="content"></div></div>');
                ...
                function init(){
				  ...
				  btFinish = $(' <a>'+options.labelFinish+'</a> ').attr("href","#").addClass("buttonFinish btn ");
                  btNext = $(' <a>'+options.labelNext+'</a> ').attr("href","#").addClass("buttonNext btn");
                ...
                function showMessage(msg){
                  $('.content',msgBox).html(msg);
              		msgBox.slideDown().delay(5000).fadeOut();
                }
