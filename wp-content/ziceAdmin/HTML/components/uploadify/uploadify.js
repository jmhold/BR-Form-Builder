		...
		jQuery.extend(jQuery.fn,{
			uploadify:function(options) {
				jQuery(this).each(function(){
					...
					uploader        : 'components/uploadify/uploadify.swf', // The path to the uploadify swf file
					script          : 'uploadify.php', // The path to the uploadify backend upload script
					expressInstall  : null, // The path to the express install swf file
					folder          : '', // The path to the upload folder
					height          : 26, // The height of the flash button
					width           : 92, // The width of the flash button
					hideButton		: true,
		  			multi			: true, 
		  			cancelImg	  : 'components/uploadify/cancel.png',// The path to the cancel image for the default file queue item container
