...
(function($) {
  ...
  $.cleditor = {
    ...
    defaultOptions: {
      ...
      controls:     // controls to add to the toolbar
                    ...
                    "indent | " +
                    "link unlink  image rule   source | " + " alignleft center alignright justify ",
					//"rule image link unlink | cut copy paste pastetext | print source",
      colors:       // colors in the color popup
                    "ffffff cccccc 999999 666666 333333 000000  ffcccc cc9999  996666  663333 " +
  ...
  cleditor = function(area, options) {
    ...
    var $group = $(DIV_TAG)
      ...
      .appendTo($toolbar);
       ...
       var $contentmain = editor.$contentmain=  $(DIV_TAG).addClass(CONMAIN_CLASS).appendTo($main);
  ...
  function hoverEnter(e) {
    ...
    $div.css(BACKGROUND_COLOR, $div.data(BUTTON_NAME) ? "#FFF" : "#FFF");
  }
  ...
  function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
    ...
    // URL
	  ...
	  $popup.html('<input type=text  size=35> <input type=button  value="Add ">');
 ...
 //   return href.substr(0, href.length - cssFile.length) + "img/";
  ...
  function refresh(editor) {
    ...
    var $contentmain = editor.$contentmain,
