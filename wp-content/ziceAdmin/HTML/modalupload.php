<script type="text/javascript" >
	...
	// mutiupload
	  ...
	  var scriptData = {'albumid':'<?php echo $_GET[albumid]?>'};
	  ...
	  'wmode'		: 'transparent',
	  'hideButton': true,
  	'queueSizeLimit' : 5, 'simUploadLimit' : 1,  'width': 92,'height': 26,
    ...
    <form  action="">
            ...
            <div style="border:#f4f4f4 20px solid; border-bottom:13px solid #f4f4f4">
              <div id="custom-queue" class="custom-queue dialog"></div>
                  ...
                  <span id="maxUploadFileSize" style="display:none"><?php echo $config['max_upload_size']?></span>
        </div>
    </form>
  </div>
</div>