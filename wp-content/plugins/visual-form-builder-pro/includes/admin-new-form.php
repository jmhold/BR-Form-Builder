	...
	<table class="form-table">
		<tbody>
			<tr valign="top">
				...
				<td>
					<input type="text" value="<?php _e( 'Enter form name here' , 'visual-form-builder-pro'); ?>" placeholder="<?php _e( 'Enter form name here' , 'visual-form-builder-pro'); ?>" autofocus="autofocus" onfocus="this.select();" class="regular-text required" id="form-name" name="form_title" />
			...
			<tr valign="top">
				...
				<td>
					...
					<p class="description"><?php _e( 'Required. This is who your emails will come from.' , 'visual-form-builder-pro'); ?></p>
				</td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td>
					...
					<p class="description"><?php _e( 'Optional (for now) - you can change this later' , 'visual-form-builder-pro'); ?></p>
				</td>
			</tr>
			<tr valign="top">
...
<li><a href="http://vfb.matthewmuro.com/documentation/" target="_blank">Official Documentation</a></li>
<li><a href="http://vfb.matthewmuro.com/faq" target="_blank">FAQ</a></li>
<li><a href="http://vfb.matthewmuro.com/forum/support" target="_blank">Support Forum</a></li>
</ol>
