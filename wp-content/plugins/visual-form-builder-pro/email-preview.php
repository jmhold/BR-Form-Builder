...
if ( $link_love == '' || $link_love == 'yes' ) {
	$html_link_love = 'This email was built and sent using <a href="http://vfb.matthewmuro.com" style="font-size: ' . $footer_font_size . 'px;font-family: ' . $font_family . ';color:' . $link_color . ';">Visual Form Builder Pro</a>.';
    ...
    <tr>
        <td align="center">
            <table class="bg2" cellspacing="0" border="0" style="background-color: #ffffff;" cellpadding="0" width="600">
                ...
                <tr>
                	<?php if ( $header_image == '' ): ?>
                    <td class="header" align="left" style="background-color:<?php echo $header_color; ?>;padding: 50px 20px 50px 20px;"><h1 style="font-family: <?php echo $font_family; ?>;font-size: <?php echo $header_font_size; ?>px;font-weight:normal;margin:0;padding:0;color:<?php echo $header_text_color; ?>;"><?php echo $form_subject; ?></h1></td>
                    <?php else: ?>
