    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ["#bedd17", "#afd8f8", "#cb4b4b", "#4da74d", "#9440ed"],
                legend: {
                    show: true,
                    noColumns: 0,
                    labelFormatter: null,
                ...
                xaxis: {
                    ...
                    color: "#aaaaaa", // base color, labels, ticks
                    tickColor: "#ececec", // possibly different color of ticks, e.g. "rgba(0,0,0,0.15)"
                ...
                yaxis: {
                    color: "#333333", // base color, labels, ticks
                ...
                grid: {
                    ...
                    borderColor: "#ececec", // set if different from the grid color
                    tickColor: "#f3f3f3", // color for the ticks, e.g. "rgba(0,0,0,0.15)"
        ...
        function insertLegend() {
            ...
            if (options.legend.container != null)
                ...
                var legend = $('<div class="legend">' + table.replace('style="', 'style="position:absolute;' + pos +'; margin:-21px 13px 0 0;') + '</div>').appendTo(placeholder);
                if (options.legend.backgroundOpacity != 0.0) {
                    ...
                    $('<div  class="legendBG" style="position:absolute;width:' + div.width() + 'px;height:' + div.height() + 'px;' + pos +'background-color:' + c + ';	 "> </div>').prependTo(legend).css('opacity', options.legend.backgroundOpacity);
                }
            }
        }
        ...
        function init(plot) // this is the "body" of the plugin
        {
                ...
                function draw(plot, newCtx)
                {
                        ...
                        if (attempts >= redrawAttempts) {
                                clear();
                            //    target.prepend('<div class="error">Not draw </div>');
                        }
...
/*! Javascript Flotting resize library 
 *
 * flot.resize.min.js
 *
 */
